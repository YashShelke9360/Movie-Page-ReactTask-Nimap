...
//           <Card.Title className="text-white">OverView :<br></br>{movie.overview}</Card.Title><br></br>
//           <Card.Title className="text-white">Rating: {movie.vote_average}</Card.Title><br></br>
      ...
      {loading ? (
        ...
        <>
          <Row>
            ...
            <Col md={8}>
              <Card.Title className="text-white">{movie.title}</Card.Title><br />
              <Card.Title className="text-white">OverView:<br></br>{movie.overview}</Card.Title><br></br>
              <Card.Title className="text-white">Rating: {movie.vote_average}</Card.Title><br></br>
              <Card.Title className="text-white">Release Date: {movie.release_date}</Card.Title><br />
